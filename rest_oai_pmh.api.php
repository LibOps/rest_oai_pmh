...
/**
 * Override the location of the template file used by a rest_oai_pmh metadata plugin.
 *
 * @param array $template
 *   The OaiMetadataMap "template" found in the Plugin's annotations
 *     e.g. Drupal\rest_oai_pmh\Plugin\OaiMetadataMap\DublinCoreMetatag's template passed here would be
 *     [
 *       "type" => "module",
 *       "name" => "rest_oai_pmh",
 *       "directory" => "templates",
